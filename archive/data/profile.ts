...
export const profile: Profile = {
  ...
  availability:
    'Available for software architecture, AI agent systems, product engineering, and technical consulting.',
  intro:
...
export const journeyExperience: ExperienceItem[] = [
  {
    ...
    description:
      'Designing and building high-performance full-stack web applications, AI automation tools, and interactive WebGL components.',
    highlights: [
  ...
  },
  {
    ...
    description:
      'Collaborative engineering focused on rapid MVP delivery, AI legal assistance RAG, and scalable frontend UI components.',
    highlights: [
